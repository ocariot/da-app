...
import org.universAAL.ontology.activity.ActivityOntology;
...
public class OntologyService extends Service {
    ...
    private static final String ONT_ONTOLOGY_LIST_FILE = "ontologies.ont";
    ...
    private static void registerOntologiesFromAPK() {
        ...
        OntologyManagement.getInstance().register(AndroidContext.THE_CONTEXT, new DeviceOntology());
        OntologyManagement.getInstance().register(AndroidContext.THE_CONTEXT, new HealthMeasurementOntology());
        OntologyManagement.getInstance().register(AndroidContext.THE_CONTEXT, new PersonalHealthDeviceOntology());
        OntologyManagement.getInstance().register(AndroidContext.THE_CONTEXT, new ActivityOntology());
    }
     ...
     *
     * @param ontFolder The folder where the dexed jar files of the ontologies are
     *                  found.
     * @param cl        Class loader to use to access the jar files.
     */
    ...
    /**
     * Inner method to load all ontologies included in the ontologies folder,
     * following the list described of ont classes in ontologies.ont.
     *
     * @param ontFolder The folder where the dexed jar files of the ontologies are
     *                  found.
     * @param cl        Class loader to use to access the jar files.
     ...
     *
     * @param activators List of the activators that were identified.
     * @param cl         Class loader to use to access the jar files.
     */
