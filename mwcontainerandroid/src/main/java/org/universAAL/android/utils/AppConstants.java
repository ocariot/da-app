...
//	public static final String ACTION_ONT_UNREG = ACTION_PREFIX + "ONT_UNREGISTER";
	...
	//Extras
	public static final String ACTION_UI_PROGRESS_X_PERCENTAGE = ACTION_PREFIX + "percentage";
...
//	public static final String ACTION_SYS_RESTART = ACTION_PREFIX + "SYS_RESTART";
	...
	public static class Defaults {
	    ...
	    public static final String CFOLDER = "/data/ocariot/universAAL/configurations/etc/";
	    public static final String OFOLDER = "/data/felix/ontologies";
	    public static final String IFOLDER = "/data/felix/configurations/etc/image";
	    public static final String USER = "Ocariot-user-default";
	...
	public static class Keys {
		public static final String ISCOORD = "uaal_setting_iscoord_key";
	    public static final String UIHANDLER = "uaal_setting_uihandler_key";
	    public static final String CONNWIFI = "uaal_setting_connwifi_key";
		public static final String MYWIFI = "home_wifi_key";
	    public static final String CFOLDER = "uaal_setting_cfolder_key";
	    public static final String OFOLDER = "uaal_setting_ofolder_key";
	    public static final String IFOLDER = "uaal_setting_ifolder_key";
	    public static final String USER = "uaal_setting_user_key";
	    public static final String TYPE = "uaal_setting_type_key";
	    public static final String CONNMODE = "uaal_setting_connmode_key";
	    public static final String CONNTYPE = "uaal_setting_conntype_key";
	    public static final String CONNURL = "uaal_setting_connurl_key";
	    public static final String CONNGCM = "uaal_setting_conngcm_key";
	    public static final String CONNUSR = "uaal_setting_connusr_key";
	    public static final String CONNPWD = "uaal_setting_connpwd_key";
		public static final String START = "uaal_setting_start_key";
		public static final String STOP = "uaal_setting_stop_key";
	}
}
