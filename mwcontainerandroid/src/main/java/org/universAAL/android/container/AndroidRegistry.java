...
public class AndroidRegistry {
     ...
     * grounding.
     *
     * @param id      The unique ID of the grounding.
     * @param parcel  The Parcelable representation of the grounding.
     * @param type    The type of uAAL wrapper.
    ...
    public static synchronized void register(String id, GroundingParcel parcel, int type, Context context) {
        switch (type) {
            case AppConstants.TYPE_CPUBLISHER:
                ...
                Log.w(TAG, "MY CONTEXT: " + context.getClass().getName());
                Log.w(TAG, "MY PARCEL: " + parcel.getAction());
     ...
     *
     * @param uri URI of the ServiceProfile which matching originated a call
