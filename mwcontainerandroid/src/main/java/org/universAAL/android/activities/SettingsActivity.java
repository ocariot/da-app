...
public class SettingsActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (wifiVal.equals(AppConstants.NO_WIFI)) {
			wifiPref.setSummary(R.string.uaal_setting_resetwifi_none);
			wifiPref.setEnabled(false);
		} else {
			wifiPref.setSummary(R.string.uaal_setting_resetwifi);
			wifiPref.setEnabled(true);
			wifiPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
				public boolean onPreferenceClick(Preference preference) {
					PreferenceManager
							.getDefaultSharedPreferences(SettingsActivity.this)
							.edit().remove(AppConstants.Keys.MYWIFI).commit();
...
//						}
						...
						Toast.makeText(getApplicationContext(),
								R.string.uaal_warning_gplay, Toast.LENGTH_LONG)
								.show();
...
//					RAPIManager.registerInThread(getApplicationContext(), (String) newValue);
						...
						Toast.makeText(getApplicationContext(),
								R.string.uaal_warning_gplay, Toast.LENGTH_LONG).show();
	...
	protected void onStop() {
		...
		if (changed) {// There was a change in settings, restart MW service
			...
			UaalConfig.load(getApplicationContext()); // Sync Preferences in UaalConfig util now that they are changed
