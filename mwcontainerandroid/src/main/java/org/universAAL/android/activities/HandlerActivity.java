...
public class HandlerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		UaalConfig.load(mContext); //Sync Preferences in UaalConfig util
		if(PreferenceManager.getDefaultSharedPreferences(this).getBoolean(AppConstants.FIRST, true)){
			...
			UaalConfig.createFiles(mContext);
		}
...
//				}
				...
				Toast.makeText(getApplicationContext(), R.string.uaal_warning_gplay,
